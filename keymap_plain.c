...
static const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  FN3 , LGUI   , LSFT , BSLS,  Z  ,  X  ,  C  ,  V  ,  B  ,  N  ,  M  , COMM, DOT , SLSH,       RSFT  ,  LEFT, DOWN, RGHT  ,    P1  , P2  , P3  , PENT,
...
//      */
 ...
 FN0 , ___   ,   2   , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___ , ___   ,   ___ , ___ , ___  ,  ___ , ___ , ___ , ___ ,
